...
exports.sendVerificationEmail = exports.sendNewsletterSubscriptionEmail = exports.sendContactFormEmail = exports.sendOrderStatusEmail = exports.sendPasswordResetEmail = exports.sendOrderConfirmationEmail = void 0;
 ...
 */
const sendOrderStatusEmail = async (toEmail, customerName, orderNumber, status) => {
    if (!process.env.SMTP_USER || !process.env.SMTP_PASS) {
        console.log('\n--- 📧 EMAIL MOCK (SMTP NOT CONFIGURED) ---');
        console.log(`To: ${toEmail}`);
    ...
    if (!isShipped && !isDelivered)
        return; // Only email for these statuses
...
exports.sendNewsletterSubscriptionEmail = sendNewsletterSubscriptionEmail;
